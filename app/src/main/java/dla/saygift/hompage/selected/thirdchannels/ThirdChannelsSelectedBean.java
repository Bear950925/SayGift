...
public class ThirdChannelsSelectedBean {
    ...
    public ArrayList<String> getHomepage_selected_channels_columns_title() {
        return homepage_selected_channels_columns_title;
    }

    public ArrayList<String> getHomepage_selected_channels_author_avatar_url() {
        return homepage_selected_channels_author_avatar_url;
    }

    public ArrayList<String> getHomepage_selected_channels_author_nickname() {
        return homepage_selected_channels_author_nickname;
    }

    public ArrayList<String> getHomepage_selected_channels_Cover_img_url() {
        return homepage_selected_channels_Cover_img_url;
    }

    public ArrayList<String> getHomepage_selected_channels_title() {
        return homepage_selected_channels_title;
    }

    public ArrayList<String> getHomepage_selected_channels_like_counts_tv() {
        return homepage_selected_channels_like_counts_tv;
    }
